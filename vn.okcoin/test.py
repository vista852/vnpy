...
apiKey = '446f4613-5225-4ef0-95a1-fd34de145ba4'
secretKey = 'FB129CE19AB90A5A4920CD0698F60F1A'

apiKey1 = '446f4613-5225-4ef0-95a1-fd34de145ba4'
secretKey1 = 'FB129CE19AB90A5A4920CD0698F60F1A'
# 创建API对象
api = OkCoinApi()

# 连接服务器，并等待1秒
api.connect(OKCOIN_USD, apiKey1, secretKey1, True)
